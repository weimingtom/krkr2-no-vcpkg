...
#if !MY_USE_MINLIB
#else
//FIXME:TODO:don't remove this function, see core/environ/android/AndroidUtils.cpp, static jobject GetKR2ActInstance()
//see KR2Activity::GetInstance
#endif	
...
#else
	//FIXME:TODO:skip, for stop crashing
#endif
